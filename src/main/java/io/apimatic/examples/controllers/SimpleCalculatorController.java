...
public class SimpleCalculatorController extends BaseController {
     ...
     * @param    GetCICDDemoForCalculatorInput    Object containing request parameters
     * @return    Returns the Double response from the API call 
     */
    public Double getCICDDemoForCalculator(
                final GetCICDDemoForCalculatorInput input
    ) throws Throwable {

        HttpRequest _request = _buildGetCICDDemoForCalculatorRequest(input);
        HttpResponse _response = getClientInstance().executeAsString(_request);
        HttpContext _context = new HttpContext(_request, _response);

        return _handleGetCICDDemoForCalculatorResponse(_context);
    }
     ...
     */
    public void getCICDDemoForCalculatorAsync(
                final GetCICDDemoForCalculatorInput input,
        ...
        Runnable _responseTask = new Runnable() {
            public void run() {
                ...
                try {
                    _request = _buildGetCICDDemoForCalculatorRequest(input);
                } catch (Exception e) {
                ...
                getClientInstance().executeAsStringAsync(_request, new APICallBack<HttpResponse>() {
                    public void onSuccess(HttpContext _context, HttpResponse _response) {
                        try {
                            Double returnValue = _handleGetCICDDemoForCalculatorResponse(_context);
    ...
    /**
     * Builds the HttpRequest object for getCICDDemoForCalculator
     */
    private HttpRequest _buildGetCICDDemoForCalculatorRequest(
                final GetCICDDemoForCalculatorInput input) throws IOException, APIException {
    ...
    /**
     * Processes the response for getCICDDemoForCalculator
     * @return An object of type void
     */
    private Double _handleGetCICDDemoForCalculatorResponse(HttpContext _context)
